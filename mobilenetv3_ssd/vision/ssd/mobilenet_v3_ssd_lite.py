...
# 9,11 所以是11
#一共是19层，所以这里是20
def create_mobilenetv3_ssd_lite(num_classes, width_mult=1.0, is_test=False, device='cpu'):
...
def create_mobilenetv3_ssd_lite_predictor(net, candidate_size=200, nms_method=None, sigma=0.5, device=torch.device('cuda')):
